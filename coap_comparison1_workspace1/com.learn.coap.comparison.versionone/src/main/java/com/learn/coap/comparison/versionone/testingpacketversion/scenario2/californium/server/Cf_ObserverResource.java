package com.learn.coap.comparison.versionone.testingpacketversion.scenario2.californium.server;
...
public class Cf_ObserverResource extends CoapResource {
	...
	public void handleGET(CoapExchange exchange) {
		exchange.respond(ResponseCode.CONTENT, "Hi!" + String.format("%06d", updateTask.getStatusUpdate()),MediaTypeRegistry.TEXT_PLAIN);
	}
