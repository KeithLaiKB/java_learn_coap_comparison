package com.learn.coap.comparison.versionone.testingpacketversion.scenario2.californium.client;
...
public class TestMain_Cf_Obs_Client {
	...
	private void run() {
    	...
    	CoapClient client = new CoapClient("coaps://192.168.50.55:5684/Resource1");	// new client
